...
Other projects I am excited to be working on now explore the role of women and gender in populist radical right parties, the rise of femonationalism, public support for gender-egalitarian policies, and the impacts of gender quota laws on women's presence in cabinets worldwide. I continue to work on measuring the mental load and its consequences for women's careers and political engagement -- and you can take a short quiz [here](https://tally.so/r/447Xxk) to see how your own mental load compares to our research on 3,000 US parents !

My Google Scholar page is [here](https://scholar.google.com/citations?user=YRH8cOoAAAAJ&hl=en).

You can find my CV [here](assets/pdf/Weeks_CV_092026.pdf){:target="_blank"}.
